...
!          Cecilia M. Bitz, UW
      ...
      integer (kind=int_kind) :: nt_fbri, nt_Tsfc, nt_hpnd, nt_apnd
      ...
      call icepack_query_tracer_indices(nt_fbri_out=nt_fbri, nt_Tsfc_out=nt_Tsfc, nt_hpnd_out=nt_hpnd, nt_apnd_out=nt_apnd)
